...
const navItems = [
  { label: 'Início', href: '/' },
  { label: 'Buscar médicos', href: '/' },
  { label: 'Favoritos', href: '#' },
  { label: 'Agendamentos', href: '#' },
  { label: 'Medário Pro', href: '/pro' },
];
const quickPrompts = [
